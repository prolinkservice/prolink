...
export default function PractitionerLinePage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="sticky top-0 z-50 bg-white border-b border-border px-4 py-3 flex items-center gap-3 shadow-sm">
        ...
        <span className="font-semibold text-lg">LINE 通知綁定</span>
      <BrandMark />
      </div>

      <div className="px-4 py-6 max-w-lg mx-auto">
        <LineLinkSection next="/practitioner/dashboard/profile/line" />
      </div>
    </div>
  )
}
